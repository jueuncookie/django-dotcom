...
urlpatterns = [
    ...
    path('double/', views.double, name='double'),#다전공게시판
    path('minor/', views.minor, name='minor'),#부전공게시판
    path('free/',  views.free, name='free'),#자유게시판
    path('information/', views.information, name='information'),#정보게시판
]